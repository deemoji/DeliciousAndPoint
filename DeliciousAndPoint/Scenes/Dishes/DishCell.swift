...
struct DishCell: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            Text(name)
                .frame(width: 109, height: 50, alignment: .leading)
